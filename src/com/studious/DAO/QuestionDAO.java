...
public class QuestionDAO extends StudiousDAO<Question, Integer> {
    ...
    final String DELETE_SQL = "DELETE FROM CAUHOI WHERE De = ?";
    ...
    public List<Question> selectSql(String Sql, Object... args) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                entity.setQuestion(rs.getString(1));
                entity.setWrongAns1(rs.getString(2));
                entity.setWrongAns2(rs.getString(3));
                entity.setWrongAns3(rs.getString(4));
                entity.setWrongAns4(rs.getString(5));
                entity.setAns(rs.getString(6));
                entity.setLessonID(rs.getInt(7));
                entity.setTeacherID(rs.getString(8));
                list.add(entity);
            }
        } catch (Exception e) {

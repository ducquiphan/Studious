...
public class StudentDAO extends StudiousDAO<Student, String> {
    ...
    final String INSERT_SQL = "INSERT INTO HOCSINH(MaHS, HoVaTen, GioiTinh, NgaySinh, MaDinhDanh, Email, Khoi, PathIMG, MaTK) VALUES (?,?,?,?,?,?,?,?,?)";
    final String UPDATE_SQL = "UPDATE HOCSINH SET HoVaTen = ?, GioiTinh = ?, NgaySinh = ?, MaDinhDanh = ?, Email = ?,  Khoi = ?, PathIMG = ?, MaTK = ? WHERE MaHS = ?";
    ...
    public void insert(Student entity) {
        JdbcHelper.update(INSERT_SQL, entity.getStudentID(), entity.getFullname(),
                entity.isGender(), entity.getBirthDate(), entity.getIdentity(),
                entity.getEmail(), entity.getGrade(), entity.getAvtURL(),
                entity.getAccountID());
    }
    ...
    JdbcHelper.update(UPDATE_SQL, entity.getFullname(), entity.isGender(),
            entity.getBirthDate(), entity.getIdentity(), entity.getEmail(), 
    ...
    public List<Student> selectSql(String Sql, Object... args) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                entity.setIdentity(rs.getString(5));
    ...
    public List<Student> selectByName(String name){
        String sql = "SELECT * FROM HocSinh WHERE HoVaTen LIKE N'%" + name + "%'";
        List<Student> list = selectSql(sql);
        if (list.isEmpty()) {
            return null;
        }
        return list;

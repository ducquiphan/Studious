 ...
 * @author Admin
 */
public class StatisticsTeacher extends java.awt.Dialog {

    /**
     * Creates new form StatisticsDocuments
     */
    public StatisticsTeacher(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                StatisticsTeacher dialog = new StatisticsTeacher(new java.awt.Frame(), true);

...
public class LessonManagement extends java.awt.Dialog {
    ...
    private void initComponents() {
        ...
        if (tblGridView.getColumnModel().getColumnCount() > 0) {
            tblGridView.getColumnModel().getColumn(0).setMinWidth(50);
            tblGridView.getColumnModel().getColumn(0).setPreferredWidth(50);
            tblGridView.getColumnModel().getColumn(0).setMaxWidth(50);
            tblGridView.getColumnModel().getColumn(1).setMinWidth(120);
            tblGridView.getColumnModel().getColumn(1).setPreferredWidth(120);
            tblGridView.getColumnModel().getColumn(1).setMaxWidth(120);
            tblGridView.getColumnModel().getColumn(3).setMinWidth(150);
            tblGridView.getColumnModel().getColumn(3).setPreferredWidth(150);
            tblGridView.getColumnModel().getColumn(3).setMaxWidth(150);
            tblGridView.getColumnModel().getColumn(4).setMinWidth(120);
            tblGridView.getColumnModel().getColumn(4).setPreferredWidth(120);
            tblGridView.getColumnModel().getColumn(4).setMaxWidth(120);
        }

 ...
 * @author Admin
 */
public class DocumentViewStudent extends java.awt.Dialog {

    /**
     * Creates new form DocumentViewStudent
     */
    public DocumentViewStudent(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(pnlBackground, java.awt.BorderLayout.CENTER);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DocumentViewStudent dialog = new DocumentViewStudent(new java.awt.Frame(), true);
